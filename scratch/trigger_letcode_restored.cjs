...
const CASE_IDS = [
  '4faa01b1-41b0-481b-957c-1ae2a0160df4' // LetCode Dialog Flow (restored)
];
...
(async () => {
  ...
  const res = await fetch(url, {
    ...
    body: JSON.stringify({ testCaseIds: CASE_IDS, generationId: '303b2e15-b7ff-4d47-8461-bfd362eefe77' })
  });
